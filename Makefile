.PHONY: build run clean test lint fmt docker docker-run help
...
CMD_PATH=./cmd/techircd
DOCKER_IMAGE=techircd:latest
...
docker-run: docker ## Build and run in Docker
	docker run -p 6667:6667 -p 6697:6697 $(DOCKER_IMAGE)
